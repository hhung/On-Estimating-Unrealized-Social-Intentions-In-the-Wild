...
\begin{teaserfigure}
  \begin{tabular}{cc}
\includegraphics[width=0.65\textwidth]{Teaser.png} & \includegraphics[width=0.32\textwidth]{AnnotatedSocialStill.png}
  \end{tabular}
...
\begin{figure}[tb]
    ...
    \vspace{-5mm}
    \label{fig:intent}
    \Description{A schematic view visualizing the taxonomy of intentions, divided into three sections: a,b, and c. Sec. a is the case where "person has intention X" and "outcome X occurs", meaning that the intended outcome is realised. This is current state-of-the-art intention estimation. Sec. b is the case where "person has intention X" and "outcome NOT X occurs", meaning that the intended outcome is not realised. This is then called unrealized intention estimation. The final section c, is the case where "person has no intentions" and "outcome X does or does not occur". This is called serendipity. }
\end{figure}
...
\begin{figure*}[tb]
    \includegraphics[width=0.7\textwidth]{SelfvsThirdPartyIntentAnnotations_v3.png}
        % \vspace{-5mm}
...
\begin{figure}[bt]
  \includegraphics[width=\columnwidth]{INTS_overview (6).png}
  \vspace{-5mm}
